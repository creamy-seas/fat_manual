...
\noindent Therefore  the flux  through the qubits,  \red{which we  count in number  of $  \mu $m
  squares e.g. 40}\ec
...
\begin{framed}\noindent
  ...
  \item Squares is number of $\mu$m$^2$ squares.
    % \item Gausses and $\mu$m already taken into account by the \blue{$ 10^{-16}$}\ec.
  \end{itemize}
\end{framed}
