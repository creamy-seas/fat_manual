\section{Interferometer}
  ...
  \begin{enumerate}
  	...
  	\item \cmd{Adjust the `guiding' mirror so that the laser light falls directly in the center of the beam splitter and `stationary' mirror \ra Adjust the `stationary' mirror so that this reflected right coincides with the incident one on the beam splitter;}
